...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-neutral-200/80 bg-white/80 dark:border-white/10 dark:bg-[#050a08]/90 backdrop-blur-xl transition-colors">
      <nav
