    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-3 bg-[var(--bg-card)] p-4 rounded-[var(--radius-md)] border border-[var(--border-hairline)]">
        <div>
          ...
          <p className="text-xs text-[var(--text-mute)]">Suriin, aprubahan, o magdagdag ng City Ordinance.</p>
        </div>
        <button
          ref={addBtnRef}
          type="button"
      ...
      {showModal && (
        <div
          role="dialog" aria-modal="true" aria-labelledby="lgu-submit-ordinance-title"
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleCreateCityOrdinance} noValidate>
              {/* Header */}
              <div className="sticky top-0 z-10 bg-[var(--bg-card)] border-b border-[var(--border-hairline)] p-5 flex items-center justify-between">
                <div>
                  <h2 id="lgu-submit-ordinance-title" className="text-base font-bold text-[var(--text-ink)]">📜 Irehistro ang Bagong City Ordinance</h2>
              ...
              <div className="p-5 space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="sm:col-span-3 flex flex-col gap-1.5">
                    <label className="text-sm font-medium text-[var(--text-ink)]">Pamagat ng Ordinansa <span className="text-red-500">*</span></label>
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-sm font-medium text-[var(--text-ink)]">Resolution Number <span className="text-red-500">*</span></label>
